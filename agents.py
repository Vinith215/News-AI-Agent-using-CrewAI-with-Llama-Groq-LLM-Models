...
from tools import google_search_tool  # <-- Use your own tool
...
researcher = Agent(
    ...
    backstory="""Former quantum computing researcher turned tech intelligence expert, known for predicting major 
